...
public class CreateListObjectTest {
    ...
    public void test2 () {
        ...
        $x(".//li[text()='Список']").click(); // В выпадающем списке в поле "Тип" выбрать Список
        String value = "Lena_LIST_SELENIDE" + random(); // объявила переменную value
