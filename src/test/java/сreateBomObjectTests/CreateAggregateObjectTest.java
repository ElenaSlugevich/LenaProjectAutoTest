...
public class CreateAggregateObjectTest {
    ...
    public void test1 () {
        ...
        $x(".//li[text()='Агрегат']").click(); // В выпадающем списке в поле "Тип" выбрать Агрегат
        String value = "Lena_AGR_SELENIDE" + random(); // объявила переменную value
